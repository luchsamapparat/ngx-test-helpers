...
export declare function expectElement(rootElement: Element, domQuery: string): jasmine.Matchers<{}>;
export declare function expectElements(rootElement: Element, domQuery: string): jasmine.ArrayLikeMatchers<{}>;
export declare function elementByQuery(rootElement: Element, domQuery: string): Element;
